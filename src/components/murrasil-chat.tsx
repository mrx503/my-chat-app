  ...
  return (
    <div className="flex h-screen w-full bg-background text-foreground overflow-hidden">
        ...
        <div className="p-4 space-y-4 border-b">
            <div className="flex justify-between items-center">
                <div className="flex items-center gap-3">
                    ...
                    <h1 className="text-2xl font-bold font-headline">Murrasil</h1>
                </div>
                <ThemeSwitcher />
            </div>
      ...
      <main className="flex-1 flex flex-col bg-muted/30">
        {selectedChat ? (
          <ChatArea chat={selectedChat} onNewMessage={handleNewMessage} />
        ) : (
          <div className="flex flex-col items-center justify-center h-full text-center">
            <Bot size={80} className="text-muted-foreground/50 mb-4" />
            <h2 className="text-2xl font-semibold">Welcome to Murrasil</h2>
